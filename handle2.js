...
const app = {
    ...
    songs: [{
        ...
        {
            name: "Illenium - God Damnit",
            singer: "ft. Call Me Karizma",
            path: "./music/7.mp3",
            image: "https://a10.gaanacdn.com/gn_img/albums/YoEWlabzXB/oEWlj5gYKz/size_xxl_1586752323.webp"
        },
        {
            name: "Deep Blue (Lyrics) ",
            singer: "ft. Monika Santucci",
            path: "./music/8.mp3",
            image: "https://i.ytimg.com/vi/QvswgfLDuPg/maxresdefault.jpg"
        },
        {
            name: "Million Days (Official Lyric Video)",
            singer: "ft. Hoang & Claire Ridgely",
            path: "./music/9.mp3",
            image: "https://a10.gaanacdn.com/gn_img/albums/YoEWlabzXB/oEWlj5gYKz/size_xxl_1586752323.webp"
        },
        {
    ...
    handleEvents: function() {
        ...
        playlist.onclick = function(e) {
            ...
            // const abc =$$(".song")[songNode.dataset.index]
            if (songNode && !e.target.closest(".option")) {
                ...
                if (songNode) {
                    ...
                    _this.render();
                    audio.play();
                    // abc.classList.add("gg");  -> không ad được class vào vì đã render lại view mất r nên obj abc không còn nữa
                    // console.log(abc)
                }
        ...
        playlist.onmousedown = (e) =>{
            ...
            // const abc =$$(".song")[songNode.dataset.index]
            if (songNode && !e.target.closest(".option")) {
                songNode.classList.add("song_click");
            }
        }
        playlist.onmouseout = (e) =>{
            const songNode = e.target.closest(".song:not(.active)");
            // const abc =$$(".song")[songNode.dataset.index]
            if (songNode && !e.target.closest(".option")) {
                songNode.classList.remove("song_click");
            }
        }
    },
